      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-16">
            MERQURIUS AVANTAGE GLOBAL was founded on a simple principle: a brand is the most valuable asset a company owns.
          ...
          <div className="bg-secondary/20 rounded-[3rem] p-12 border border-border/50 mb-24">
            <h2 className="text-3xl font-serif mb-12 text-center">The MERQURIUS AVANTAGE GLOBAL Standards</h2>
