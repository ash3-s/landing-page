        ...
        <div className="grid lg:grid-cols-5 gap-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Scale your authority with MERQURIUS AVANTAGE GLOBAL. Our brand strategists are ready to define your market leadership.
            </p>
          ...
          <div className="lg:col-span-3 bg-secondary/20 rounded-[2.5rem] p-8 md:p-10 border border-border/50">
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="message"
                  placeholder="Tell us about your brand goals and market objectives..."
